...
class Navigation_business(BusinessWebPage):
    ...
    class Admin_settings_menu_item():
        ...
        def tab_page_number(self):
            tab_page_ele = self.obj.find_elements(By.XPATH,'//div[contains(@class, "tab-page")]/*')
            i=0
            for item in tab_page_ele:
                i=i+1
            return i
    ...
    def __init__(self, driver):
        ...
        self.menu = {
            ...
            'Stream Migration': self.Admin_settings_menu_item(name="Stream Migration", obj=self, has_subitems=True, parent=None, is_clickable=True, by=self._page.streammigration_button, tab_by=None),
